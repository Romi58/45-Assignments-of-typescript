...
//solution:
var name1 = "ahmed";
console.log("Lowercase:".concat(name1.toLocaleLowerCase()));
console.log("Upeercase : ".concat(name1.toUpperCase()));
console.log("Titlecase :".concat(name1.charAt(0).toUpperCase() + name1.slice(1).toLowerCase()));
...
var quote1 = "We realize the importance of our voices only when we are silenced.";
...
//Solution:
var person1 = "Fatima";
console.log("Assalam-o-Alaikum, ".concat(person1, "! Welcome to the program.")); //this program said welcome
var person2 = "Ali";
console.log("Khuda Hafiz, ".concat(person2, "! Thank you for using the program.")); //this program said thank you
...
//Solution:
var namesofPersons = ["Ahmed", "Fatima", "Ali", "Aisha"];
...
//solution:
var names = ["Ahmed", "Fatima", "Ali", "Aisha"];
var messagein = "Assalam-o-Alaikum, NAME! I hope you're having a great day.";
for (var i = 0; i < names.length; i++) {
    var personalizedMessage = messagein.replace("NAME", names[i]);
...
// solution:
var favoriteTransportation = ["Tesla Model S", "BMW M5", "Harley-Davidson Iron 883"];
...
//Solution:;
var guestList = ["Malala Yousafzai", "Abdul Sattar Edhi", "Imran Khan"];
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestList[i], ", you are cordially invited to dinner. Please let us know if you can join us."));
}
...
//Solution:
var guestListof = ["Malala Yousafzai", "Abdul Sattar Edhi", "Imran Khan"];
var guestWhoCantMakeIthere = guestListof.splice(1, 1)[0];
console.log("".concat(guestWhoCantMakeIthere, " can't make it to the dinner."));
guestListof.push("Allama Iqbal");
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestListof[i], ", you are cordially invited to dinner. Please let us know if you can join us."));
}
...
//Solution:
var guestListofguest = ["Malala Yousafzai", "Abdul Sattar Edhi", "Imran Khan"];
var guestWhoCantMakeIt = guestListofguest.splice(1, 1)[0];
console.log("".concat(guestWhoCantMakeIt, " can't make it to the dinner."));
guestList.push("Allama Iqbal");
for (var i = 0; i < guestListofguest.length; i++) {
    console.log("Dear ".concat(guestListofguest[i], ", you are cordially invited to dinner. Please let us know if you can join us."));
}
...
for (var i = 0; i < guestList1.length; i++) {
    console.log("Dear ".concat(guestList1[i], ", you are cordially invited to dinner. Please let us know if you can join us."));
}
...
for (var i = 0; i < guestList1.length; i++) {
    console.log("Dear ".concat(guestList1[i], ", you are still invited to dinner. Please let us know if you can join us."));
}
guestList1.pop();
guestList1.pop();
...
console.log("We've found a bigger dinner table! We can now invite more guests. Total guests invited: ".concat(guestList0.length));
guestList0.unshift("New Guest 1", "New Guest 2", "New Guest 3");
for (var i = 0; i < guestList0.length; i++) {
    console.log("Dear ".concat(guestList0[i], ", you are cordially invited to dinner. Please let us know if you can join us."));
}
console.log("We've just been informed that the new dinner table won't arrive in time. We can now invite only two guests.");
while (guestList0.length > 2) {
    var removedGuest = guestList0.pop();
    console.log("Sorry, ".concat(removedGuest, ", we can't invite you to dinner."));
}
...
console.log(banana);
console.log(orange);
var item1 = { name: "Laptop", price: 1000 };
var item2 = { name: "Mobile Phone", price: 500 };
var item3 = { name: "Watch", price: 100 };
console.log("Item 1:", item1);
console.log("Item 2:", item2);
console.log("Item 3:", item3);
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestList[i], ", you are still invited to dinner. Please let us know if you can join us."));
}
guestList.pop();
guestList.pop();
...
var guestWhoCantMakeIt2 = guestList4[3];
console.log("".concat(guestWhoCantMakeIt2, " can't make it to the dinner."));
...
//solution:
var alien_color3 = 'green'; // Change the color to 'yellow' or 'red' to see different messages
...
//Solution:
var usernames = ["admin", "ali", "bilal", "kaif", "rehman"];
...
//Solution:
var usernames2 = ["admin", "ali", "saima", "samreen", "ahmed"];
if (usernames2.length === 0) {
    console.log("We need to find some users!");
}
else {
    for (var _a = 0, usernames2_1 = usernames2; _a < usernames2_1.length; _a++) {
        var username = usernames2_1[_a];
        if (username === "admin") {
            console.log("Hello admin, would you like to see a status report?");
        }
        else {
...
//Solution:f
var current_users = ["ali", "waiza", "hamza", "wanina", "samina"];
var new_users = ["abdullah", "jawwad", "sara", "jhon", "sam"];
for (var _b = 0, new_users_1 = new_users; _b < new_users_1.length; _b++) {
    ...
    for (var _c = 0, current_users_1 = current_users; _c < current_users_1.length; _c++) {
        var current_username = current_users_1[_c];
...
for (var _d = 0, numbers2_1 = numbers2; _d < numbers2_1.length; _d++) {
    var number = numbers2_1[_d];
    var ordinal = void 0;
    if (number === 1) {
        ordinal = "st";
    }
...
//solution:
var pizzas = ["Margherita", "Pepperoni", "Chicken Tikka"];
for (var _e = 0, pizzas_1 = pizzas; _e < pizzas_1.length; _e++) {
    var pizza = pizzas_1[_e];
...
var album2 = make_album("Nusrat Fateh Ali Khan", "Sangam");
var album3 = make_album("Ali Zafar", "Jhoom", 12);
console.log(album1);
console.log(album2);
console.log(album3);
...
var magicians1 = ["Harry Houdini", "David Copperfield", "Penn Jillette", "Teller"];
...
var magiciansin = ["Junaid Akram", "Zakir Khan", "Moin Akhtar", "Umar Sharif"];
var great_magiciansis = make_great3(__spreadArray([], magicians, true));
